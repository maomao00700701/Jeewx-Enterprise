...
<div class="row  border-bottom white-bg dashboard-header">
    <div class="col-sm-12">
        <blockquote class="text-warning" style="font-size:14px">您是否想拥有一款JAVA的微信企业号开发平台…
            <br>您是否需要一款企业级J2EE快速开发平台，提高开发效率，缩短项目周期…
            <br>您是否一直在苦苦寻找一款强大的代码生成器，节省码农的繁琐重复工作…
            <br>…………
            <h4 class="text-danger">那么，现在 "JEEWX微信企业号平台" 来了</h4>
        </blockquote>
        <hr>
    </div>
    <div class="col-sm-3">
    ...
    <div class="col-sm-5">
        ...
        <p>JEEWX 微信企业号平台，是基于JEECG3.6.3版本开发，采用插件方式提供，如果你的系统采用JEECG3.6.3版本开发，可以轻松集成JEEWX微信企业号插件。
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h5 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#version" href="#v42">v3.6.3</a><code class="pull-right">2016.04.09</code>
                                    </h5>
                                </div>
