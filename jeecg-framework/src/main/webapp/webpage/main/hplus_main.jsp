...
<head>
    ...
    <meta name="keywords" content="JEEWX,后台bootstrap框架,会员中心主题,后台HTML,响应式后台">
    <meta name="description" content="JEEWX,是一个完全响应式，基于Bootstrap3最新版本开发的扁平化主题，她采用了主流的左右两栏式布局，使用了Html5+CSS3等现代技术">

    <link rel="shortcut icon" href="plug-in-ui/hplus/favicon.ico">
                ...
                <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="JEEWX微信企业号平台  开源…" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="plug-in-ui/hplus/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="plug-in-ui/hplus/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
...
<script src="plug-in-ui/jquery-plugs/storage/jquery.storageapi.min.js"></script>
<script>
    function logout(){
