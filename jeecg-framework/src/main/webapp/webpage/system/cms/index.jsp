...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<%=basePath %>/plug-in/cms/cms/css/iscroll.css">
		...
		<script src="<%=basePath %>/plug-in/cms/cms/js/h.js" type="text/javascript"></script>
		<script src="<%=basePath %>/plug-in/cms/cms/js/iscroll.js" type="text/javascript"></script>
        <script type="text/javascript">
            var myScroll;
            function loaded() {
	...
	<div class="banner">
		...
		<div id="nav">
			...
			<ul id="indicator">
				<li class="">1</li><li class="">2</li><li class="">3</li><li class="active">4</li>
			</ul>
